...
public class master
{
    ...
    public class island
    {
        ...
        public island()
        {
            ...
            popCarn = 0;
            exp = 0;
            //Dictionary of all animal names to the animal objects
            animals = new Dictionary<string, animal> { {"Bear", new master.animal("Bear", "Ursidae", "Carnivore", 3, 0, new string [] {"Bunny"}, new string[] {"" }) },
